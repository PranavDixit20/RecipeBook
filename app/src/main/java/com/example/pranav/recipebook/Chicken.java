 ...
 */
public class Chicken extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chicken);
        {
            ...
            ArrayAdapter<String> adpt = new ArrayAdapter<String>(this,R.layout.chicken);
