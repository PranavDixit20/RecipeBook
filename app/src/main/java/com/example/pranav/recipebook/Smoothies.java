 ...
 */
public class Smoothies extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.smoothies);
        {
            ...
            ArrayAdapter<String> adpt = new ArrayAdapter<String>(this,R.layout.smoothies);
